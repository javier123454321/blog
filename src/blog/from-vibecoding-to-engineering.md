...
* Once all the issues are ready, give the Orchestrator agent the lssues to delegate (sequentially).<a name="ref2"></a>[(2)](#note2)&nbsp;-&gt; **Outcome is a PR stack which has all the code and a sequential step by step history of all the work done.**
