...
- Writing is important (and I should do more of it).
- You talk about ownership — that's the only way I work.
- Your growth plan is a breath of fresh air.
- I want a remote job that pays well.

## Things You'll Love About Me
...
I use AI tools excessively, and they have honestly made me super productive. It is amazing how fast ideas can come to life.

I am a designer by trade before a developer, so asking "Is this even the right question?" is my MO. It is also one of my frustrations with engineering culture — we don't ask that enough.

I am also business-minded. I have been an operator of a few businesses, with varying success.

I worked in sales for almost a decade during university. Being customer-facing is something I miss.

I have been prototyping nonstop since AI tools made it possible.

I won't tout my kindness and thoughtfulness, but I think we'll share a lot of values. I love that this is in the job application.

I don't just live in the US — I'm in the Midwest, the most US out of all the US.
...
Let's start with the big enterprise stuff. At Adusa, I am part of Team Zero, a team that sets standards for the company. We work on componentizing our design system, upgrading our frontend infrastructure, migrating our CMS across the whole site, and rebuilding our build systems. I've written about some of this: [moving from Webpack to Vite, saving hundreds of dev hours](/blog/i-fixed-a-bug) after two other engineers failed at the task, [setting up the design pattern that allowed the component library to be extracted and upgraded](/blog/functional-core-imperative-shell), or [simply fixing a bug that seemed unfixable](/blog/i-fixed-a-bug). I also revamped the build pipelines and did other critical infrastructure work.

Our team is focused on performance and stability, and we've been able to keep our Lighthouse score — for a company serving content to millions of users daily — in the high 90s. I'm quite proud of that.
...
If you made it here, thank you. I'll leave my resume and take this as a cover letter. Feel free to browse some of my poetry or my blog posts.
