...
The single biggest challenge is how to take well-meaning volunteers that wanted to do something and give them the tools to actually execute. The catch is that you know that they will not stay around long-term. How do you simplify construction?

<div class="mx-auto max-w-2xl bg-white p-8 border-2">
<img src="/images/screenshot-2026-08-03_16-20-48-1.png"/>

We had to focus our efforts on different parts of the process. We didn't have much time as we were going to start building soon while we collected all the materials. And we had a decent gauge of which were the parts that tended to get people confused. So we focused on those parts.

</div>



{% render "partials/components/media-card.liquid", image: '/images/screenshot-2026-08-03\_16-22-49.png', alt: 'screenshot-2026-08-03\_16-22-49', side: 'right', text: 'We based our approach on Ikea guides. The most user friendly design guidelines for furniture. The end result definitely felt much friendlier than the previous one. And it was a successful project. We ended up building a hundred and eighty shelters for this project.' %}
...
{% render "partials/components/pdf-embed.liquid", url: '/images/Manual-de-Constru-VIVIENDA-VERTICAL-v2-1.pdf', name: 'Manual-de-Constru-VIVIENDA-VERTICAL-v2-1' %}
</div>
